...
public:
   ...
   void satinoff();
   void set_decor_stitch(int index);
   void decor_on(int index);
   void decor_off();
   void pendown();
   void penup();
   Point position();
...
private:
   ...
   void arrow_stitch_to(const Point &pos);
   void zigzag_stitch_to(const Point &pos);
   void feather_stitch_to(const Point &pos);
